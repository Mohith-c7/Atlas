      ...
      <div className="mx-auto grid w-full max-w-3xl gap-6">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-semibold leading-tight">Plan and usage controls</h1>
            <p className="mt-3 max-w-2xl text-sm leading-6 text-muted">
              Review SaaS plan state, entitlements, usage counters, checkout, and billing portal
              access.
            </p>
          </div>
          <Link
