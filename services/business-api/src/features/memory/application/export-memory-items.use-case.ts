import type { ExportMemoryItemsResponse } from "@faios/contracts";
...
const MEMORY_EXPORT_LIMIT = 1000;

export class ExportMemoryItemsUseCase {
  ...
  public async execute(
    ...
    const memories = await this.repository.listMemoryItems(founder.id, MEMORY_EXPORT_LIMIT);
